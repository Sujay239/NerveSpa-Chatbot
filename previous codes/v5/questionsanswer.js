...
// Default output
let outputValue = "Sorry, I couldn't find a relevant answer for your question. Please try a different question or contact support directly at support@nervespa.com";
...
function stem(w) {
  ...
  return w.replace(/(ing|ly|ed|er|es|s)$/, "");
}
